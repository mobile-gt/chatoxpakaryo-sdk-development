...
public class Label extends LinearLayout {
    ...
    AutoLabelUiModel autoLabelUiModel;

    public AutoLabelUiModel getAutoLabelModel() {
        return autoLabelUiModel;
    }

    public void setAutoLabelModel(AutoLabelUiModel instructionModel) {
        this.autoLabelUiModel = instructionModel;
    }
    ...
    private void init(final Context context, int textSize, int iconCross,
        ...
        final View labelView = inflater.inflate(R.layout.autolabel_view, this, true);
