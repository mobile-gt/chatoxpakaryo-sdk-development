...
public class AutoLabelUISettings implements Parcelable {
    ...
    public static final int DEFAULT_ICON_CROSS              = R.drawable.ic_close_white_24dp;
...
//        setBackgroundResource(builder.bBackgroundResource);
    ...
    public static final class Builder {
        ...
        private int bTextSize               = R.dimen.dimen_10dp;
        private int bBackgroundResource     = R.color.grey_400;
        private boolean bLabelsClickables   = DEFAULT_LABELS_CLICKABLES;
        private int bLabelPadding           = R.dimen.dimen_4dp;
